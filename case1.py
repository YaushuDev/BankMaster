...
class Case:
    def __init__(self):
        ...
        self.name = "Caso 1"
        self.description = "Responde con 'hola' a emails específicos"
        self.search_keywords = []
        self.response_message = "hola"
    ...
    def process_email(self, email_data, logger):
        ...
        try:
            ...
            logger.log(f"Procesando caso1 para email de {sender} con asunto: {subject}", level="INFO")
            ...
            logger.log(f"Respuesta generada para caso1: '{self.response_message}'", level="INFO")
